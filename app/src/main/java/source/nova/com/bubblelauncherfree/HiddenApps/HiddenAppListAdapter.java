...
public class HiddenAppListAdapter extends ArrayAdapter<DataObj> {
    public HiddenAppListAdapter(Context context, ArrayList<DataObj> apps) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.hidden_app_item, parent, false);
        }

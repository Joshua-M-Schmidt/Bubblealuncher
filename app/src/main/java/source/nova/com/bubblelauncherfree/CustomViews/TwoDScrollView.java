...
public class TwoDScrollView extends FrameLayout {
    ...
    private class ScaleListener
        ...
        public boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
            zoomListener.onZoomStart(scaleGestureDetector);
            return true;
        }
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            //mScaleFactor = mScaleFactor*mScaleFactor*mScaleFactor;
            // Don't let the object get too small or too large.

            mScaleFactor = Math.max(0.1f, Math.min(mScaleFactor, 1.0f));
            if (zoomListener != null) {
                zoomListener.onZoom(mScaleFactor,detector);
            }

            Log.i("Scale Facttor", mScaleFactor+" ");
            return true;
        }
    }
    ...
    public interface ZoomListener{
        void onZoomStart(ScaleGestureDetector detector);
        void onZoom(float scale, ScaleGestureDetector detector);
    }
